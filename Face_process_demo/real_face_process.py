...
def process():
    ...
    root = '/HDD0/guozonghui/project/datasets/Celeba-all/Celeba/img_celeba'
    ...
    for clip in tqdm(data_list_split):
        ...
        for frame_name in clip:
            tmp = frame_name.replace('/img_celeba/', '/img_celeba_crop_align/')
        ...
        if len(frames) > 0:
            ...
            for faces, frame, frame_name in zip(detect_res, frames, clip):
                ...
                if len(faces) > 0:
                    ...
                    frame_name = frame_name.replace('/img_celeba/', '/img_celeba_crop_align/')
